...
<table class="table table-hover"> 
 <tbody> 
  <tr bgcolor="ff4b00"> 
   ...
   <td width="600"><span style="color: white;"><b>avi.vs.ip()</b></span></td> 
  </tr> 
  <tr> 
   <td width="100"><span style="font-size: medium;"><strong>Description</strong></span></td> 
   <td width="600">Returns the virtual service IP address which accepted the request or connection.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td width="600">Dotted decimal IP address string.</td> 
  </tr> 
  <tr> 
