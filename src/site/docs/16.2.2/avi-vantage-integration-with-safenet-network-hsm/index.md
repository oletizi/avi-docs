...
layout: default
---
**Note: Those still on Avi Vantage 16.2 should instead read <a href="/docs/latest/vantage-integration-with-safenet-network-hsm-16-2">Vantage Integration with SafeNet Network HSM (16.2)</a>.**
