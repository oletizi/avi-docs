...
**Note: Regardless of the configured caching policy, an object can be cached only if it is <a href="/docs/16.2.2/overview-of-http-cache/">eligible for caching</a>. Some objects may not be eligible for caching.**
