...
layout: default
---
**Note: Users of Vantage 16.2.2 should instead read <a href="/docs/16.2.2//avi-vantage-integration-with-safenet-network-hsm-16-2-2">Vantage Integration with SafeNet Network HSM (16.2.2)</a>.**
