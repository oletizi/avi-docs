...
<!-- [Format Time: 0.0010 seconds] --> For variable data that needs to be saved across connections or mirrored to other Service Engines for the virtual service use <a href="/docs/latest/datascript-avi-vs-table_insert">avi.vs.table_insert()</a></td>
</tr>
<tr>   
