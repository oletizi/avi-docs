...
* **Source - Event**: An event triggers the alert.  See the <a href="/docs/latest/events-list">Event List</a> for a list and brief description of all events.
...
* **<a href="img/AlertConfig-3.png"><img src="img/AlertConfig-3.png" alt="AlertConfig-3" width="322" height="212"></a>Source - Metric**:  Metrics trigger the alert. When the Source is set to Metric, a few different options are presented. See the <a href="/docs/latest/metrics-list">Metric List</a> for a list and brief description of all metrics.
