...
* Use AWS IAM roles: can be selected if the Avi Controller VM in AWS was created using an <a href="/docs/latest/iam-role-setup-for-installation-into-aws">appropriate IAM role</a>.
