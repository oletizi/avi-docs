...
* <a href="/docs/latest/avi-vantage-integration-with-safenet-network-hsm">SafeNet HSM support</a>: Vantage can use the key generation and encryption/decryption services provided by SafeNet Network HSM.
* HA features
