...
<a href="img/snat-iptopo1.png"><img src="img/snat-iptopo1.png" alt="snat-iptopo1" width="557" height="264"></a>
...
* If creating a new virtual service, click Create &gt; Advanced Setup.
* If adding SNAT to an existing virtual service, click the edit icon in the row where the virtual service is listed.
* On the Advanced tab, enter the SNAT IP in the SNAT IP Address field. If the SE group allows scaling out to more than one SE, add a unique SNAT IP for each SE. Use a comma between each IP as a delimiter.
* Click Save.
...
<a href="img/snat-iptopo2.png"><img src="img/snat-iptopo2.png" alt="snat-iptopo2" width="614" height="434"></a>
...
<a href="img/L2-HA-Cluster.png"><img src="img/L2-HA-Cluster.png" alt="L2-HA-Cluster" width="1025" height="840"></a>
...
<a href="img/snat-iptopo3.png"><img src="img/snat-iptopo3.png" alt="snat-iptopo3" width="615" height="420"></a>
...
Here is the SNAT configuration in the web interface for Virtual Service 1 in the example topology.
<a href="img/L2-Legacy-HA.png"><img src="img/L2-Legacy-HA.png" alt="L2-Legacy-HA" width="1027" height="839"></a>
...
<a href="img/snat-iptopo4.png"><img src="img/snat-iptopo4.png" alt="snat-iptopo4" width="613" height="422"></a>
Here is the SNAT configuration in the web interface for Virtual Service 1 in the example topology.

<a href="img/L3-HA-Dynamic.png"><img src="img/L3-HA-Dynamic.png" alt="L3-HA-Dynamic" width="1026" height="841"></a>
