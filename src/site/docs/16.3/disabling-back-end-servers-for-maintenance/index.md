...
Note: Vantage also can be configured to use information in the health-check responses from servers to detect when a server is in maintenance mode. For information, <a href="/docs/16.2.2/detecting-server-maintenance-mode-with-a-health-monitor">click here</a>.
