...
* **After completing the deployment process, clik <a href="{% vpath %}/virtual-service-creation-vmware/">here</a> to learn how to create virtual services.**
...
**If deploying in no access mode, <a href="#Avi SEint">one final setup item</a> is required. If deploying in write access or read access mode, the procedure is complete!** Now Vantage is ready for <a href="{% vpath %}/virtual-service-creation-vmware/">creation of virtual services</a>.
