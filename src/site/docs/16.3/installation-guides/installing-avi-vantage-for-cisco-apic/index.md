...
This completes the installation phase of deployment. The next phase is to create a virtual service: <a href="/docs/16.2.2/virtual-service-create-apic">Virtual Service Creation: APIC</a>
