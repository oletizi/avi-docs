...
Note: This guide applies to installation within an on-premises cloud. If you are deploying into a Mesos cluster within Amazon Web Services (AWS), go <a href="{% vpath %}/installing-mesos-in-aws-using-the-cli-16-1/">here</a> instead.
