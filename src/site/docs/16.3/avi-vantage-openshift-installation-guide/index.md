...
Please refer to <a href="/openshift-service-account-for-avi-vantage-authentication/">OpenShift Service Account for Avi Vantage Authentication</a>.
...
* Check "Cluster user overlay SDN" for overlay-based networking for the cluster, such as OpenShift, Nuage and Weave. Uncheck for Flannel and Routed containers. 
* Click Next. 
