...
After completing the IAM role setup steps above, go <a href="/docs/16.3/installation-guides/installing-avi-vantage-in-amazon-web-services">here</a> to install the Avi Vantage EC2 instance.
