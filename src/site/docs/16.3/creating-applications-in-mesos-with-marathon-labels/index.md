...
* **avi_proxy** - Used for service configuration. The avi_proxy label has 2 sub-objects: virtualservice and pool. These objects use the same JSON schema as the <a href="{% vpath %}/api-guide/">Avi REST API</a>.
...
(For more information about using BGP RHI for virtual service scaling, <a href="{% vpath %}/bgp-support-for-virtual-services">click here</a>.)
