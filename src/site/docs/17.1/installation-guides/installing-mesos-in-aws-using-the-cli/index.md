...
Note: This guide applies to installation using the CLI. To install using the AWS web interface and a CloudFormation template from Avi Networks instead, go <a href="{% vpath %}/installation-guides/installing-avi-integration-with-mesos-in-aws">here</a>.

If you are installing into an on-premises Mesos or DC/OS cloud, go <a href="{% vpath %}/installation-guides/installing-avi-vantage-with-mesosphere-dcos-on-premises/">here</a> instead.
