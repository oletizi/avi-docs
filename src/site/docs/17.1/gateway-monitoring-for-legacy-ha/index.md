...
* The current release supports gateway health monitoring only for Avi SEs configured for <a href="{% vpath %}/legacy-ha-for-avi-service-engines/">legacy high availability (HA)</a>.
* Another article of interest:  <a href="{% vpath %}/avi-se-behavior-on-gateway-monitor-failure/">Avi SE Behavior on Gateway Monitor Failure</a>
