...
* More examples are available in the <a href="/docs/17.1/why-is-a-server-marked-down">Reasons a Server Can Be Marked Down</a>. 
...
See <a href="/docs/17.1/packet-capture">Packet Capture</a> for more help on this topic.
...
<a href="/docs/17.1/manually-validate-server-health" target="_blank">Manually Validate Server Health</a>
