...
This article steps through the UI screens required to configure a custom alert notification.  See the <a href="{% vpath %}/alerts-overview">Alerts Overview</a> for a broader explanation of the alert process.
