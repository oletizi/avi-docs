...
* **After completing the deployment process, go <a href="{% vpath %}/configuring-a-virtual-service-for-vmware-basic">here</a> to create virtual services.**
...
**If deploying in no access mode, <a href="#SEint">one final setup item</a> is required. If deploying in write access or read access mode, the procedure is complete!** Now Vantage is ready for <a href="{% vpath %}/configuring-a-virtual-service-for-vmware-basic">creation of virtual services</a>.
