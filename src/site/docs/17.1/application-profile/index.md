...
* <a href="{% vpath %}/layer-4-ssl-support">SSL Profile</a>
...
* **Save:** Select another tab from the top menu to continue editing or Save to return to the Application Profiles tab. See also the <a href="{% vpath %}/preserve-client-ip/">Preserve Client IP</a> article.
...
More granular settings also may be configured using <a href="/docs/configuration-guide/applications/vs-policies/">policies</a> or <a href="{% vpath %}/datascript-guide/">DataScripts</a>.
...
**Note: Regardless of the configured caching policy, an object can be cached o<a href="img/Screen-Shot-2016-10-24-at-7.11.49-PM.png"><img class="alignright wp-image-16748" src="img/Screen-Shot-2016-10-24-at-7.11.49-PM.png" alt="Screen Shot 2016-10-24 at 7.11.49 PM" width="375" height="118"></a>nly if it is <a href="{% vpath %}/overview-of-http-cache/">eligible for caching</a>. Some objects may not be eligible for caching.**
