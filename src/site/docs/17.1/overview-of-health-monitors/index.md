...
* <a href="{% vpath %}/why-is-a-server-marked-down">Reasons a Server Marked Down</a>
...
* <a href="{% vpath %}/dns-health-monitor">DNS Monitor</a>
* <a href="{% vpath %}/external-health-monitor">External Monitor</a>
* <a href="{% vpath %}/http-health-monitor">HTTP Monitor</a>
* <a href="{% vpath %}/https-health-monitor">HTTPS Monitor</a>
* <a href="{% vpath %}/ping-health-monitor">Ping Monitor</a>
* <a href="{% vpath %}/tcp-health-monitor">TCP Monitor</a>
* <a href="{% vpath %}/udp-health-monitor">UDP Monitor</a>
