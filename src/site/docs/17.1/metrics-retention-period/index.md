...
layout: layout171
---
At regular intervals, Avi Service Engines collect values for a <a href="{% vpath %}/metrics-list">wide range of metrics</a> and sends them to the Avi Controller. The Controller then aggregates these metric values into several buckets.
