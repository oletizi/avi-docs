...
* If client authentication requires NTLM, disable Connection Multiplex in the *Templates &gt; Profiles &gt; HTTP App* profile.  See <a href="{% vpath %}/issues-with-ntlm-authentication">NLTM </a>for more on this.
