...
* **Per Application:** Limits per-SE placement of virtual services to a maximum of 2 virtual services per SE.Note: This option affects how vCPUS are counted for <a href="/docs/17.1/terms-of-avi-vantage-license">licensing</a> purposes.
...
* **HSM Group:** Applies a template of hardware security module (HSM) settings to the SE group. For more information about HSM support:  
    ...
    * <a href="/docs/17.1/avi-vantage-integration-with-safenet-network-hsm/">Avi Vantage Integration with SafeNet Network HSM</a> 