...
**Avi Vantage** -&gt; <a href="{% vpath %}/ipam-and-dns-provider-avi-vantage">https://kb.avinetworks.com/ipam-and-dns-provider-avi-vantage/</a>

**Infoblox** -&gt; <a href="{% vpath %}/ipam-and-dns-provider-infoblox">https://kb.avinetworks.com/ipam-and-dns-provider-infoblox/</a>

**AWS IPAM** -&gt; <a href="{% vpath %}/ipam-and-dns-provider-aws">https://kb.avinetworks.com/ipam-and-dns-provider-aws/</a>

**Openstack IPAM** -&gt; <a href="{% vpath %}/ipam-and-dns-provider-openstack">https://kb.avinetworks.com/ipam-and-dns-provider-openstack/</a>
