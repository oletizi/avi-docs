...
For more advanced capabilities, see <a href="{% vpath %}/overview-of-datascript/">DataScripts</a>.
...
If the profile is set to redirect HTTP to HTTPS via port 443, and the policy is set to redirect HTTP to HTTPS on port 8443, the client will be sent to port 8443. (See <a href="{% vpath %}/datascript-execution-priority/">Execution Priority</a> for more on this topic.)
