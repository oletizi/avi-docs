...
After completing the IAM role setup steps above, go <a href="/docs/17.1/installation-guides/installing-avi-vantage-in-amazon-web-services">here</a> to install the Avi Vantage EC2 instance.
