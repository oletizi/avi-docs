...
<img src="img/vs-logs-displaying.png" alt="vs-logs-displaying" width="881" height="529" class="alignnone size-full wp-image-5294" />
...
*   **Number and Range:** <img src="img/vs-logs-displaying-timestamp.png" alt="vs-logs-displaying-timestamp" width="654" height="25" class="alignnone size-full wp-image-5296" /> Total number of log items being displayed. The date/time range of those logs appear beneath the Search field on the left. The number will reflect how many logs passed the filter, which may be lower than the total number of logs.
...
*   **Histogram:** <img src="img/vs-logs-histogram.png" alt="vs-logs-histogram" width="639" height="121" class="alignnone size-full wp-image-5298" /> The histogram shows the number of client log entries over the selected time period. The X-axis is time, while the Y-axis is the number of logs during that bar’s period of time.
