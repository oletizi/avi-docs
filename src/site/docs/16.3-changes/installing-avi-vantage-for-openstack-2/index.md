...
<a href="/installing-avi-vantage-for-openstack-16-3/">CLICK FOR LATEST VERSION</a>
...
<ol> 
 ...
 <li>Enter OpenStack settings: 
  ...
  </ul> <p><a href="img/openstack-deploy-openstacklogin-selectkeystone.png"><img class="alignnone size-full wp-image-8512" src="img/openstack-deploy-openstacklogin-selectkeystone.png" alt="openstack-deploy-openstacklogin-selectkeystone" width="264" height="246"></a></p></li> 
...
<ol> 
 ...
 <li>Enter OpenStack settings: 
  <ul> 
   ...
   <li>IP address of Keystone server</li> 
   <li>Keystone Auth enabled</li> 
  </ul> <p><a href="img/openstack-deploy-openstacklogin-selectkeystone.png"><img class="alignnone size-full wp-image-8512" src="/wp-content/uploads/2016/02/openstack-deploy-openstacklogin-selectkeystone.png" alt="openstack-deploy-openstacklogin-selectkeystone" width="264" height="246"></a></p></li> 
