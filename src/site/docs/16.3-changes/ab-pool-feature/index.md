...
<ol> 
 ...
 <li>Click the edit icon in the row for the pool name.</li> 
 <li>Click Advanced.</li> 
 <li>In the Pool A/B Testing Settings section, select the B pool from the A/B Test pool pull-down list.</li> 
 <li>In the Percentage of Requests field, enter the percentage of new sessions to send to pool B instead of pool A. (Existing sessions on pool A are not affected.)</li> 
 <li>Click Save.</li> 
</ol> 

<a href="img/a-b-pool.png"><img class="alignnone size-full wp-image-5785" src="img/a-b-pool.png" alt="a-b-pool" width="624" height="227"></a>
