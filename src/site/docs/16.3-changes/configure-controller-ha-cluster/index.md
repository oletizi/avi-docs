...
<ol> 
 ...
 <li><a href="/controller-cluster-ip/">Controller cluster IP</a>: Choose an IP address to use as the <a href="/controller-cluster-ip/">Cluster IP address</a>. Note: As of Avi Vantage 16.3, <a href="/cluster-configuration-with-fqdn/">DNS host names may be specified in lieu of IP addresses</a>. 
  <ul> 
