...
* <a href="/ssh-users-and-keys/#ssh-key-based-controller-login">SSH Key-based Login to Avi Controller</a> (new for Avi Vantage release 16.3) 
...
Similarly, to exit the Avi Vantage shell into Linux, type: <code>bash</code>
...
When jumping from Linux bash to the Avi Vantage shell, or from the Avi Vantage shell to Linux bash, you may return to the previous mode by typing: <code>exit</code>
