...
Note: This guide applies to installation within an on-premises cloud. If you are deploying into a Mesos cluster within Amazon Web Services (AWS), go <a href="/docs/16.2/installation-guides/installing-mesos-in-aws-using-the-cli/">here</a> instead.
...
<ol class="md-ignore"> 
 <li>Configure basic system settings: 
  ...
  <div> 
   <p> <img src="img/mesos-install-adminacct-162.png" alt="" width="275" height="399" align="left" hspace="0&quot;" vspace="6"> <img src="img/mesos-install-dnsntp-262.png" alt="" width="275" height="353" align="left" hspace="12" vspace="6"></p> 
...
* <a href="/docs/16.2/creating-applications-in-mesos-with-marathon-labels">Creating Applications with Mesos / Marathon Labels</a>
* <a href="/docs/16.2/service-discovery-for-mesos">DNS-based Service Discovery for Mesos</a> 