...
* **avi_shell**-16.1.5000.tar.gz (or later): Can be used with all infrastructure types. If installing this version of the CLI shell, <a href="/docs/16.2/cli-installing-the-cli-shell">go here</a> instead. 
