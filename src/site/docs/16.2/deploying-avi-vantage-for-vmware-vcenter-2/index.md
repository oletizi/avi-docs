...
* **After completing the deployment process, go <a href="/docs/16.2/configuring-a-virtual-service-for-vmware-basic">here</a> to create virtual services.** 
...
**If deploying in no access mode, <a href="/docs/16.2/configuring-a-virtual-service-for-vmware-basic">creation of virtual services</a>.**
**
