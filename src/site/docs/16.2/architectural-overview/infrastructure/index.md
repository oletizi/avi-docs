...
* **Actions:**  
    ...
    * **Edit** the Alert filter to make Vantage more or less sensitive to generating new <a href="/docs/16.2/configuration-guide/operations/alerts/">alerts</a>.
...
* <a href="/docs/16.2/elastic-ha-for-avi-service-engines/">Elastic HA</a> 
