...
* <a href="/docs/16.2/layer-4-ssl-support">SSL Profile</a>
...
* **Type:** Type of application profile:  
    ...
    * **SSL**: Catch-all for any virtual service that is SSL-encrypted and not using an application-specific profile.
...
The initial settings for a new profile are similar regardless of the type of profile chosen:<img class="wp-image-10824 alignright" src="img/Screen-Shot-2016-07-11-at-10.49.02-AM.png" alt="Screen Shot 2016-07-11 at 10.49.02 AM" width="203" height="61">

* **Name:** Enter a unique name for the profile.
* **Description:** Enter an optional description for the profile.
* **Type:** Click the appropriate type button to select the application for this profile. Select L4 or SSL for none, for non-SSL- and SSL-encrypted, respectively. 
...
<a name="HTTP_app_profile_security_tab"></a>
...
* **Validation Type:** Enables client validation based on their SSL certificates.  
    ...
    * **Required:** Vantage requires a certificate to be presented by the client, and the certificate must pass the CRL check. The client certificate, or relevant fields, may still be passed to the server through an HTTP header.
...
**Note: Regardless of the configured caching policy, an object can be cached only if it is <a href="/docs/16.2/overview-of-http-cache/">eligible for caching</a>. Some objects may not be eligible for caching.**
