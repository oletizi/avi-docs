...
* **avi_lbaas**-16.1.9014.tar.gz (or later): Can be used if the infrastructure type is OpenStack, and Keystone support is enabled. (This is an option during initial Avi Controller setup and also can be configured later.) To install this version of the CLI shell, <a href="/docs/16.2/installation-guides/installing-the-lbaas-driver-cli-shell-openstack">go here</a> instead. 
...
&gt; Note: If installing a CLI shell to manage an OpenStack write access mode deployment with Keystone support enabled, <a href="/docs/16.2/installation-guides/installing-the-lbaas-driver-cli-shell-openstack">go here</a> instead.
 <ol> 
